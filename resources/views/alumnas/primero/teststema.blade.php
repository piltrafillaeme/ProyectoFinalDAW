...
@if(session('datos'))
    ...
    <div class="text-center testsTemas">
        <h4 class="section-title h1">Exámenes del tema <strong>'{{ $tema->nombretema}}'</strong></h4>
    </div>
                    ...
                    @foreach ($notasTestsHechos as $nota)
                        ...
                        <div class="card tarjeta test">
                            ...
                            <div class="card-body botonTests">
                                <p >Ya has hecho este examen.</p><br>
                ...
                @foreach ($testsSinHacer as $sinHacer) 
                    <div class="card tarjeta test">
                        ...
                        <div class="card-body botonTests">
                            ...
                            <a href="{{ route('primero.vertest', $sinHacer->id)}}" type="button"
        ...
        @else
            <div class="card tarjeta test">
                <div class="card-body botonTests">
                    ...
                    <a href="{{ route('primero.vertemas', Auth::user()->clase)}}" type="button"
